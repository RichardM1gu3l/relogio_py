...
saudacao    =   Label(root, bg='#1d1d1d', fg='#b5b5b5', font=('Sitka',16))
saudacao.pack()

data    =   Label(root, bg='#1d1d1d', fg='#b5b5b5', font=('Sitka',14))
data.pack(pady=2)

horas   =   Label(root, bg='#1d1d1d', fg='#b5b5b5', font=('Sitka',64, 'bold'))
horas.pack(pady=2)
